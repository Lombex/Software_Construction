...
{
    public class Test_Controller_Vehicles
    {
        [Fact]
        public async Task GetVehicles_With_Missing_UserId_Claim_Should_Return_Unauthorized()
        {
            // Arrange
            var mockVehiclesService = new Mock<IVehiclesService>();

            var controller = new C_Vehicles(mockVehiclesService.Object);
        ...
        [Fact]
        public async Task GetMyVehicles_With_Invalid_UserId_Claim_Should_Return_Unauthorized()
        {
            // Arrange
            var mockVehiclesService = new Mock<IVehiclesService>();
